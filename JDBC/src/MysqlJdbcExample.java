    ...
    public List<Department> getAllDepartment(){
        ...
        try (
            ...
            while (resultSet.next()) {
                ...
                departments.add(department); // 리스트에 추가
            }
        } catch (SQLException e) {
            e.printStackTrace(); // 예외가 발생한 과정의 정보를 출력
        }
        ...
        try (Connection connection = DriverManager.getConnection(
             ...
             ResultSet resultSet = statement.executeQuery(query)) {
                 while (resultSet.next()) {
                     ...
                     String joindate = resultSet.getString("입사일");
                     String DepartmentName = resultSet.getString("부서명");
                     System.out.println(name + " " + joindate + " " + DepartmentName);
                 }
        } catch (SQLException e) {
            e.printStackTrace();
        }
